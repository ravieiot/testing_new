...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'customer', 'middleware' => ['auth:api', 'customer_is_block']], function () {
        ...
        Route::group(['prefix' => 'order'], function () {
            ...
            Route::post('details', 'OrderController@get_order_details');
            Route::post('place', 'OrderController@place_order');
            Route::put('cancel', 'OrderController@cancel_order');
            Route::put('returned_order_initiate', 'OrderController@returned_order_initiate');
             Route::get('returned_order/{id}', 'OrderController@returned_order');
...
//            Route::post('chat-image', 'ConversationController@chat_image');
    ...
    Route::group(['prefix' => 'delivery-man'], function () {
      ...
      Route::get('send-mail', function () {
                    ...
                    \Mail::to('ravisharma.eiot@gmail.com')->send(new \App\Mail\MyTestMail($details));
