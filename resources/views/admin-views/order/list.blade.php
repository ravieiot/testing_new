...
@section('content')
    ...
    {{--                                    {{\App\Model\Order::where(['order_status'=>'pending'])->count()}}--}}
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <a class="order--card h-100" href="{{route('admin.orders.list',['returned_order_initiate'])}}">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                            <img src="{{asset('public/assets/admin/img/delivery/4.png')}}" alt="dashboard" class="oder--card-icon">
                                            <span>{{translate('returned_order_initiate')}}</span>
                                        </h6>
                                        <span class="card-title text-danger">
                                        {{ $count_data['returned_order_initiate'] }}
                                    </span>
                                    </div>
                                </a>
                            </div>
