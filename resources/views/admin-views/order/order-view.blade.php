    ...
    <div class="content container-fluid">
        ...
        <div class="row" id="printableArea">
            <div class="col-lg-8 order-print-area-left">
                ...
                <!-- End Card -->
                @isset($order['return_reason'])
                <div class="card-body">
                    <h5 class="form-label mb-3">
                        <span>Reason For Returning Order</span>
                    </h5>
                    <div class="media align-items-center deco-none">
                        ...
                        <div class="hs-unfold w-100">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu text-capitalize" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item"
                                        onclick="route_alert('{{route('admin.orders.status',['id'=>$order['id'],'order_status'=>'out_for_return'])}}','{{ translate("Change status to Out For Return ?") }}')"
                                        href="javascript:">{{translate('Out For Return')}}</a>
                                </div>
                            </div>
                        </div>
