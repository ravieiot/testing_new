...
{{--                        <form--}}
{{--                            action="{{env('APP_MODE')!='demo'?route('admin.business-settings.web-app.payment-method-update',['6cash']):'javascript:'}}"--}}
{{--                            method="post">--}}
{{--                            @csrf--}}
{{--                            @if(isset($config))--}}

{{--                                <h5 class="d-flex flex-wrap justify-content-between">--}}
{{--                                    <span class="text-uppercase">{{translate('6cash')}}</span>--}}
{{--                                    <label class="switch--custom-label toggle-switch toggle-switch-sm d-inline-flex">--}}
{{--                                        <span class="mr-2 switch--custom-label-text text-primary on text-uppercase">on</span>--}}
{{--                                        <span class="mr-2 switch--custom-label-text off text-uppercase">off</span>--}}
{{--                                        <input type="checkbox" name="status" value="1" class="toggle-switch-input" {{$config?($config['status']==1?'checked':''):''}}>--}}
...
{{--                                <div class="payment--gateway-img">--}}
{{--                                    <img src="{{asset('/public/assets/admin/img/6cash.png')}}" alt="public">--}}
{{--                                </div>--}}

{{--                                <div class="form-group">--}}
{{--                                    <input type="text" class="form-control" name="public_key"--}}
{{--                                           value="{{env('APP_MODE')!='demo'?$config['public_key']??'':''}}" placeholder="{{translate('public key')}}">--}}
{{--                                </div>--}}
{{--                                <div class="form-group">--}}
{{--                                    <input type="text" class="form-control" name="secret_key"--}}
{{--                                           value="{{env('APP_MODE')!='demo'?$config['secret_key']??'':''}}" placeholder="{{translate('secret key')}}">--}}
{{--                                </div>--}}
{{--                                <div class="form-group">--}}
{{--                                    <input type="text" class="form-control" name="merchant_number"--}}
{{--                                           value="{{env('APP_MODE')!='demo'?$config['merchant_number']??'':''}}" placeholder="{{translate('merchant number')}}">--}}
{{--                                </div>--}}
{{--                                <div class="text-right">--}}
{{--                                    <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"--}}
{{--                                            onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}"--}}
