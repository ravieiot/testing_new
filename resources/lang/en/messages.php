<?php return array (
  ...
  'The [Price Star] team' => 'The [Price Star] team',
  'Thanks' => 'Thanks',
  'This password reset is only valid for the next 24 hours.' => 'This password reset is only valid for the next 24 hours.',
  'You recently requested to reset your password for your Price Star Mobile Application account. Your Password Reset Token is' => 'You recently requested to reset your password for your Price Star Mobile Application account. Your Password Reset Token is',
  'Hi There' => 'Hi There',
  'returned_order_initiate' => 'Returned order initiate',
  'returned order initiate' => 'Returned order initiate',
  'Returned Order Initiate' => 'Returned Order Initiate',
  'Product_deleted' => 'Product deleted',
  'ReturnInitiate' => 'ReturnInitiate',
  'Change status to Return Initiate ?' => 'Change status to Return Initiate  ',
  'Return Initiate' => 'Return Initiate',
  'return_order_initiate' => 'Return order initiate',
  'return initiate' => 'Return initiate',
  'return_initiate' => 'Return initiate',
  'Change status to Out For Return ?' => 'Change status to Out For Return  ',
